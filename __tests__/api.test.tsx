...
import populationHandler, { PopulationComposition } from '../pages/api/population/[prefectureCode]'
...
describe('/api/population/[prefectureCode]', () => {
  it('return prefecture population', async () => {
    ...
    const mockRes = httpMocks.createResponse<NextApiResponse>() as NextApiResponse<PopulationComposition[]>
