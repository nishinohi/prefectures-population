...
export default async function handler(req: NextApiRequest, res: NextApiResponse<PopulationComposition[]>) {
  ...
  const data: PopulationCompositionResponse = await poplationRes.json()
